"""
Django settings for mobiz_assessment project.
...
SECRET_KEY = 'django-insecure-ylt26quyoubfo1biput8ai5&qve&n+c@n)fxp1p5#ahkj#2m-v'
...
ROOT_URLCONF = 'mobiz_assessment.urls'
